    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-gray-100">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">MIS ERP System</h1>
          <p className="text-gray-600 mt-2">Urban Local Bodies & Awas Vikas</p>
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          © 2024 Government of Uttar Pradesh. All rights reserved.
        </p>
      </div>
    </div>
  )
